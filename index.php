...
<body class="bg-light w-100">
    ...
    $s=0;
     require('lottery.php');
    ?>
    <div class="container-fluid navbar justify-content-center bg-dark  border border-dark border-4 rounded-bottom w-100">
    <h1 class="text-info py-4 display-4 ">รางวัลล็อตเตอรี่ Diversition</h1></div>
    ...
    <div class="position-absolute top-50 end-0 translate-middle-y "><input class="btn btn-light btn-lg border border-secondary border-5 rounded-pill py-3 mb-3 "  type='submit' name='shuffle' value='ดำเนินการสุ่มรางวัล' style=" font-size: 30px;"></div>
    </form>
    
    <table class="table table-bordered table-hover rounded-3 text-center ms-5 w-75 mt-5">
        <colgroup>
